...
def train(context: ModelContext, **kwargs):
    ...
    temp_tb_dbname = "DEMO_USER"
    temp_vw_dbname = "DEMO_USER"
    perm_tb_dbname = "DEMO_ModelOps_db"

    print(f"temp db is {temp_tb_dbname} , view db is {temp_vw_dbname} and perm db is {perm_tb_dbname}")
