...
def train(context: ModelContext, **kwargs):
    ...
    LR_classifier = osml.LogisticRegression()
    LR_classifier.fit(X_train, y_train)
    LR_classifier.deploy(model_name="LR_classifier", replace_if_exists=True)
        
    print("Complete osml training...")
    
    # Calculate feature importance and generate plot
    feature_importance = compute_feature_importance(LR_classifier.modelObj,X_train)
