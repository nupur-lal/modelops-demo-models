...
def score(context: ModelContext, **kwargs):
  ...
  predict_df =LR_classifier.predict(X_test)
  ...
  predictions_pdf = predict_df.to_pandas(all_rows=True).rename(columns={"logisticregression_predict_1": target_name})
  ...
  predictions_pdf[entity_key] = test_df.select(["CustomerID"]).get_values()
